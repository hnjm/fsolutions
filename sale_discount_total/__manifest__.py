...
{
    'name': 'Discount & Installation on Total Amount',
    'version': '15.0.1.0.0',
...
Installation fees for Total Amount
=======================
Module to manage discount on total amount in Sale.
        as an specific amount or percentage
""",
    'depends': ['sale','account','purchase','print_invoice_ksa'],
    'data': [
        'views/sale_view.xml',
        ...
        'views/ksa_print_invoice_view.xml',
