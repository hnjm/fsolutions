...
class Company(models.Model):
    ...
    discount_product_id = fields.Many2one('product.product',domain="[('type', '=', 'service')]")
...
class ResDiscountSettings(models.TransientModel):
    ...
    discount_product_id = fields.Many2one('product.product',related='company_id.discount_product_id',string="Discount Product", readonly=False)
