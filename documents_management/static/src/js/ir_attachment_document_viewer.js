odoo.define('documents_management.IrAttachmentDocumentViewer', function (require) {
    "use strict";
     ...
     * @deprecated
     */
    var IrAttachmentDocumentViewer = Widget.extend({
        ...
        /**
         * The IrAttachmentDocumentViewer takes an array of objects describing attachments in
        ...
        _updateContent: function () {
            this.$('.o_viewer_content').html(QWeb.render('IrAttachmentDocumentViewer.Content', {
                widget: this
            }));
            this.$('.o_viewer_img').on("load", _.bind(this._onImageLoaded, this));
            this.$('[data-toggle="tooltip"]').tooltip({delay: 0});
    ...
    return IrAttachmentDocumentViewer;
    });
