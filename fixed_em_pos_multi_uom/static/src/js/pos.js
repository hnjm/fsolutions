odoo.define("fix_em_pos_multi_uom", function (require) {
  "use strict";
  ...
  models.Order = models.Order.extend({
    set_orderline_options: function (orderline, options) {
      _super_order.set_orderline_options.call(this, orderline, options);
      if (options.wvproduct_uom !== undefined) {
        orderline.set_product_uom(options.wvproduct_uom.id);
      }
    },
  });
  ...
  models.Orderline = models.Orderline.extend({
    initialize: function (attr, options) {
      ...
      this.wvproduct_uom =
        options.json && options.json.wvproduct_id
          ? this.pos.units_by_id[options.json.wvproduct_id[0]]
          : "";
    },
    ...
    get_unit: function () {
      ...
      return this.wvproduct_uom == ""
        ? this.pos.units_by_id[unit_id]
        : this.wvproduct_uom;
    },
    ...
    export_as_JSON: function () {
      ...
      json.product_uom =
        this.wvproduct_uom == "" ? unit_id[0] : this.wvproduct_uom.id;
      return json;
    },
